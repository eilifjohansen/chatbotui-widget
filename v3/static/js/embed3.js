  ...
  setTimeout(() => {
    ...
    */
    function setUserResponse(message) {
      ...
      document.querySelector(".chats").insertAdjacentHTML('beforeend','<div class="clearfix"></div>');
      // fadeElIn("")
    ...
    function setBotResponse(response) {
      ...
      setTimeout(function () {
        ...
        if (response.length < 1) {
          ...
          document.querySelector(".chats").insertAdjacentHTML('beforeend','</p><div class="clearfix"></div>')
          document.querySelectorAll('.chats .botMsg')[document.querySelectorAll('.chats .botMsg').length - 1].fadeIn(1000)
          document.querySelectorAll('.chats .botAvatar')[document.querySelectorAll('.chats .botAvatar').length - 1].fadeIn(1000)
        } else {
          ...
          for (i = 0; i < response.length; i++) {
            ...
            if (response[i].hasOwnProperty("image")) {
              document.querySelector(".chats").insertAdjacentHTML('beforeend', '<div class="singleCard">' +
              '<img class="imgcard" src="' +
              response[i].image +
              '">' +
              '</div><div class="clearfix">');
              document.querySelectorAll('.chats .imgcard')[document.querySelectorAll('.chats .imgcard').length - 1].fadeIn(1000)
            }
            ...
            if (response[i].hasOwnProperty("attachment")) {
              ...
              if (response[i].attachment.type == "video") {
                ...
                document.querySelector(".chats").insertAdjacentHTML('beforeend', '<div class="video-container"> <iframe src="' +
                video_url +
                '" frameborder="0" allowfullscreen></iframe> </div>')
                document.querySelectorAll('.chats iframe')[document.querySelectorAll('.chats iframe').length - 1].fadeIn(1000)
              }
            }
    ...
    function renderPdfAttachment(data) {
      ...
      document.querySelector(".chats").insertAdjacentHTML('beforeend', '<div class="pdf_attachment">' +
      '<div class="row">' +
      ...
      "</div>" +
      "</div>");
      document.querySelectorAll('.chats .pdf_attachment')[document.querySelectorAll('.chats .pdf_attachment').length - 1].fadeIn(1000)
      scrollToBottomOfResults();
    }
    ...
    function renderDropDwon(data) {
      ...
      document.querySelector(".chats").insertAdjacentHTML('beforeend', '<div class="dropDownMsg"><select class="browser-default dropDownSelect"> <option value="" disabled selected>Choose your option</option>' +
      options +
      "</select></div>")
      document.querySelectorAll('.chats .dropDownMsg')[document.querySelectorAll('.chats .dropDownMsg').length - 1].fadeIn(1000)
      scrollToBottomOfResults();
    ...
    function addSuggestion(textToAdd) {
      setTimeout(function () {
        ...
        document.querySelector(".chats").insertAdjacentHTML('beforeend', ' <div class="singleCard"> <div class="suggestions"><div class="menu"></div></div></diV>');
    ...
    function showCardsCarousel(cardsToAdd) {
      ...
      document.querySelectorAll('.chats .cards')[document.querySelectorAll('.chats .cards').length - 1].fadeIn(1000)
      scrollToBottomOfResults();
    ...
    function showQuickReplies(quickRepliesData) {
      ...
      document.querySelector(".chats").insertAdjacentHTML('beforeend', '<div class="quickReplies">' +
      chips +
      '</div><div class="clearfix"></div>');
      document.querySelectorAll('.chats .quickReplies')[document.querySelectorAll('.chats .quickReplies').length - 1].fadeIn(1000)
      scrollToBottomOfResults();
    ...
    function showBotTyping() {
      document.querySelector(".chats").insertAdjacentHTML('beforeend', '<img class="botAvatar" id="botAvatar" src="' +
      botphoto +
      '"/><div class="botTyping">' +
